// Mudamos para Atualização 1!
const CONSELHO_ATUAL = "Atualização 1"; 

// ============================================================================
// ESCALA FIXA DA ATUALIZAÇÃO 1 E MOTOR DE DATAS
// ============================================================================
const ESCALA_ATUALIZACAO1 = [
...
// ============================================================================
// 3. RENDERIZAR CARDS (VOLTAMOS PARA O VISUAL ORIGINAL!)
// ============================================================================
function renderizarCards() {
    ...
    ESCALA_ATUALIZACAO1.forEach(item => {
        if (item.separador) {
