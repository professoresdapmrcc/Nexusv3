// Mudamos para Documentação! O Firebase vai procurar "conselho_Documentação" e "estagiario_Documentação"
const CONSELHO_ATUAL = "Documentação"; 

// ============================================================================
// ESCALA FIXA DA DOCUMENTAÇÃO (Seg, Qua e Sex são estagiário)
// ============================================================================
const ESCALA_DOCUMENTACAO = [
    // Bloco 1: Lista de Membros
...
async function carregarDadosPagina() {
    ...
    // =========================================================================
    // 2. BUSCAR OS RESPONSÁVEIS NO DIÁRIO (LÊ DA PASTA OFICIAL FIXA)
    // =========================================================================
...
function renderizarCards() {
    ...
    ESCALA_DOCUMENTACAO.forEach(item => {
        if (item.separador) {
