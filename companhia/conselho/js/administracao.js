// Mudamos para Administração! O Firebase vai procurar "conselho_Administração" e "estagiario_Administração"
const CONSELHO_ATUAL = "Administração"; 

// ============================================================================
// ESCALA FIXA DA ADMINISTRAÇÃO E MOTOR DE DATAS
// ============================================================================
const ESCALA_ADMINISTRACAO = [
...
async function carregarDadosPagina() {
    ...
    const periodoAtual = getPeriodoDaSemana(); // Pegamos a data limite da semana
...
// ============================================================================
// 3. RENDERIZAR CARDS (VISUAL ORIGINAL MANTIDO E REGRA BLINDADA)
// ============================================================================
function renderizarCards() {
    ...
    ESCALA_ADMINISTRACAO.forEach(item => {
        if (item.separador) {
